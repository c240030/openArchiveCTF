"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[397], {
    1134: function(t, e, i) {
        i.d(e, {
            Z: function() {
                return d
        ...
        let u = (0,
        n.forwardRef)( (t, e) => {
            let {color: i="currentColor", size: s=24, strokeWidth: r=2, absoluteStrokeWidth: a, className: u="", children: d, iconNode: c, ...p} = t;
            return (0,
            n.createElement)("svg", {
                ref: e,
                ...h,
    ...
    1093: function(t, e, i) {
        ...
        var s, r = i(7294);
        let a = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"]
          , o = new Set(a)
          , l = t => 180 * t / Math.PI
        ...
        function V(t) {
            return E(t) || C(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
        }
        function C(t) {
            var e, i;
        ...
        function k(t, e=0, i=1, n, s) {
            t.min = D(t.min, e, i, n, s),
            t.max = D(t.max, e, i, n, s)
        }
        ...
        let O = new Set(["width", "height", "top", "left", "right", "bottom", ...a])
        ...
        function tu(t, e) {
            let i = !1
              ...
              , r = () => i = !0
              , a = tl.reduce( (t, i) => (t[i] = function(t, e) {
                let i = new Set
                  , n = new Set
                  , s = !1
                  , r = !1
            ...
            t), {})
              ...
              , f = () => {
                ...
                i = !1,
                to.useManualTiming || (s.delta = n ? 1e3 / 60 : Math.max(Math.min(r - s.timestamp, 40), 1)),
                s.timestamp = r,
                s.isProcessing = !0,
                o.process(s),
                l.process(s),
        ...
        let {schedule: td, cancel: tc, state: tp, steps: tm} = tu("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : ta, !0)
          , tf = new Set
          , tg = !1
          , ty = !1
          , tv = !1;
        ...
        class tT {
            ...
            scheduleResolve() {
                ...
                this.isAsync ? (tf.add(this),
                tg || (tg = !0,
                td.read(tw),
                td.resolveKeyframes(tx))) : (this.readKeyframes(),
                this.complete())
            }
            readKeyframes() {
            ...
            cancel() {
                "scheduled" === this.state && (tf.delete(this),
                this.state = "pending")
            }
            resume() {
        ...
        let tP = t => /^0[^.\s]+$/u.test(t)
          ...
          , tM = (t, e) => i => !!("string" == typeof i && tA.test(i) && i.startsWith(t) || e && null != i && Object.prototype.hasOwnProperty.call(i, e))
          , tE = (t, e, i) => n => {
            if ("string" != typeof n)
                return n;
            let[s,r,a,o] = n.match(tS);
            return {
                [t]: parseFloat(s),
                [e]: parseFloat(r),
                [i]: parseFloat(a),
          ...
          , tD = {
            ...
            transform: ({red: t, green: e, blue: i, alpha: n=1}) => "rgba(" + tC.transform(t) + ", " + tC.transform(e) + ", " + tC.transform(i) + ", " + tb(N.transform(n)) + ")"
        }
          , tk = {
            test: tM("#"),
            parse: function(t) {
          ...
          , tR = {
            ...
            transform: ({hue: t, saturation: e, lightness: i, alpha: n=1}) => "hsla(" + Math.round(t) + ", " + Y.transform(tb(e)) + ", " + Y.transform(tb(i)) + ", " + tb(N.transform(n)) + ")"
        }
          , tL = {
            test: t => tD.test(t) || tk.test(t) || tR.test(t),
            parse: t => tD.test(t) ? tD.parse(t) : tR.test(t) ? tR.parse(t) : tk.parse(t),
            transform: t => "string" == typeof t ? t : t.hasOwnProperty("red") ? tD.transform(t) : tR.transform(t),
            getAnimatableNone: t => {
                let e = tL.parse(t);
                return e.alpha = 0,
                tL.transform(e)
        ...
        function tI(t) {
            let e = t.toString()
              ...
              , s = []
              , r = 0
              , a = e.replace(tO, t => (tL.test(t) ? (n.color.push(r),
            s.push(tB),
            i.push(tL.parse(t))) : t.startsWith("var(") ? (n.var.push(r),
            s.push("var"),
        ...
        function tN(t) {
            ...
            return t => {
                ...
                for (let r = 0; r < n; r++)
                    ...
                    void 0 !== t[r]) {
                        let e = i[r];
                        e === tF ? s += tb(t[r]) : e === tB ? s += tL.transform(t[r]) : s += t[r]
                    }
                return s
            }
        }
        let t$ = t => "number" == typeof t ? 0 : tL.test(t) ? tL.getAnimatableNone(t) : t
          , tW = {
            test: function(t) {
                return isNaN(t) && "string" == typeof t && (t.match(tS)?.length || 0) + (t.match(tj)?.length || 0) > 0
            },
            parse: tU,
        ...
        class tQ extends tT {
            ...
            resolveNoneKeyframes() {
                ...
                for (let e = 0; e < t.length; e++) {
                    var n;
                    (null === t[e] || ("number" == typeof (n = t[e]) ? 0 === n : null === n || "none" === n || "0" === n || tP(n))) && i.push(e)
                }
                i.length && function(t, e, i) {
                    let n, s = 0;
                    for (; s < t.length && !n; ) {
                        let e = t[s];
                        "string" == typeof e && !tJ.has(e) && tI(e).values.length && (n = t[s]),
                        s++
                    }
                    if (n && i)
                        for (let s of e)
            ...
            measureInitialState() {
                ...
                this.measuredOrigin = tr[i](t.measureViewportBox(), window.getComputedStyle(t.current)),
            ...
            measureEndState() {
                ...
                let s = i.length - 1
                  , r = i[s];
                i[s] = tr[e](t.measureViewportBox(), window.getComputedStyle(t.current)),
        ...
        let t2 = {
            now: () => (void 0 === n && t2.set(tp.isProcessing || to.useManualTiming ? tp.timestamp : performance.now()),
            n),
            set: t => {
                n = t,
                queueMicrotask(t1)
        ...
        class t7 {
            ...
            setCurrent(t) {
                ...
                null === this.canTrackVelocity && void 0 !== t && (this.canTrackVelocity = t4(this.current))
            }
            ...
            get() {
                return t6.current && t6.current.push(this),
                this.current
            }
            getPrevious() {
                return this.prev
        ...
        class eb {
            ...
            constructor({parent: t, props: e, presenceContext: i, reducedMotionConfig: n, blockInitialAnimation: s, visualState: r}, a={}) {
                this.current = null,
            ...
            mount(t) {
                ...
                this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || ed.current),
            ...
            readValue(t, e) {
                ...
                return null != i && ("string" == typeof i && (tt(i) || tP(i)) ? i = parseFloat(i) : !ee(i) && tW.test(e) && (i = tG(t, e)),
            ...
            on(t, e) {
                return this.events[t] || (this.events[t] = new t9),
                this.events[t].add(e)
            }
            notify(t, ...e) {
            ...
            if (!e.transform && (l || i ? n.transform = function(t, e, i) {
                ...
                for (let r = 0; r < eE; r++) {
                    ...
                    if (void 0 === l)
                        continue;
                    let h = !0;
                    if (!(h = "number" == typeof l ? l === (o.startsWith("scale") ? 1 : 0) : 0 === parseFloat(l)) || i) {
                        let t = eA(l, tZ[o]);
                        if (!h) {
                            s = !1;
                            let e = eM[o] || o;
        ...
        function ek(t, {layout: e, layoutId: i}) {
            return o.has(t) || t.startsWith("origin") || (e || void 0 !== i) && (!!eD[t] || "opacity" === t)
        }
        function eR(t, e, i) {
            let {style: n} = t
              , s = {};
            for (let r in n)
                (t0(n[r]) || e.style && t0(e.style[r]) || ek(r, t) || i?.getValue(r)?.liveStyle !== void 0) && (s[r] = n[r]);
            return s
        }
        class eL extends eS {
            constructor() {
                super(...arguments),
                this.type = "html",
                this.renderInstance = eC
            }
            readValueFromInstance(t, e) {
                if (o.has(e))
                    return this.projection?.isProjecting ? f(e) : y(t, e);
                {
        ...
        function eO(t, {attrX: e, attrY: i, attrScale: n, pathLength: s, pathSpacing: r=1, pathOffset: a=0, ...o}, l, h, u) {
            if (eV(t, o, h),
            l) {
        ...
        function eN(t, e, i) {
            let n = eR(t, e, i);
            for (let i in t)
                (t0(t[i]) || t0(e[i])) && (n[-1 !== a.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] = t[i]);
            return n
        }
        class e$ extends eS {
            constructor() {
            ...
            renderInstance(t, e, i, n) {
                !function(t, e, i, n) {
                    for (let i in eC(t, e, void 0, n),
                    e.attrs)
                        t.setAttribute(eI.has(i) ? i : ej(i), e.attrs[i])
                }(t, e, 0, n)
            }
            mount(t) {
        ...
        let eW = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];
        function ez(t) {
            if ("string" != typeof t || t.includes("-"))
                ;
            else if (eW.indexOf(t) > -1 || /[A-Z]/u.test(t))
                return !0;
            return !1
        }
        var eY = i(5893);
        ...
        try {
            ...
            "function" == typeof s && (e1 = t => t.startsWith("on") ? !e0(t) : s(t))
        } catch {}
        let e2 = (0,
        ...
        let e3 = t => (e, i) => {
            ...
            r.useContext)(eZ)
              , s = (0,
            r.useContext)(e2)
              , a = () => (function({scrapeMotionValuesFromProps: t, createRenderState: e}, i, n, s) {
                return {
          ...
          , e9 = e3({
            ...
            createRenderState: e_
        })
          , e4 = e3({
            scrapeMotionValuesFromProps: eN,
            createRenderState: eJ
        })
          , e6 = Symbol.for("motionComponentSymbol");
        function e7(t) {
            return t && "object" == typeof t && Object.prototype.hasOwnProperty.call(t, "current")
        }
        let e8 = "data-" + ej("framerAppearId")
          , it = (0,
        r.createContext)({})
          , ie = eu ? r.useLayoutEffect : r.useEffect;
        function ii(t, {forwardMotionProps: e=!1}={}, i, n) {
            i && function(t) {
                for (let e in t)
                    er[e] = {
                        ...er[e],
            ...
            function a(i, a) {
                ...
                if (!u && eu) {
                    ...
                    d.visualElement = function(t, e, i, n, s) {
                        ...
                        d && !d.projection && s && ("html" === d.type || "svg" === d.type) && function(t, e, i, n) {
                            let {layoutId: s, layout: r, drag: a, dragConstraints: o, layoutScroll: l, layoutRoot: h, layoutCrossfade: u} = e;
                ...
                eY.jsxs)(eZ.Provider, {
                    ...
                    eY.jsx)(l, {
                        ...
                        ...h
                    }) : null, function(t, e, i, {latestValues: n}, s, a=!1) {
                        let o = (ez(t) ? function(t, e, i, n) {
                            let s = (0,
                            r.useMemo)( () => {
                                let i = eJ();
                                return eO(i, e, eU(n), t.transformTemplate, t.style),
                                {
                                    ...i.attrs,
                                    style: {
                                        ...i.style
                        ...
                        : function(t, e) {
                          ...
                          , l = function(t, e, i) {
                            let n = {};
                            for (let s in t)
                                ("values" !== s || "object" != typeof t.values) && (e1(s) || !0 === i && e0(s) || !e && !e0(s) || t.draggable && s.startsWith("onDrag")) && (n[s] = t[s]);
                            return n
                        }(e, "string" == typeof t, a)
                          , h = t !== r.Fragment ? {
                            ...l,
                          ...
                          , {children: u} = e
                          , d = (0,
                        r.useMemo)( () => t0(u) ? u.get() : u, [u]);
                        return (0,
                        r.createElement)(t, {
                            ...h,
                            children: d
                        })
                    }(t, i, (o = d.visualElement,
                    (0,
                    r.useCallback)(t => {
                        t && c.onMount && c.onMount(t),
                        o && (t ? o.mount(t) : o.unmount()),
                        a && ("function" == typeof a ? a(t) : e7(a) && (a.current = t))
                    }
                    , [o])), c, u, e)]
                })
            }
        ...
        let iy = (t, e, i) => {
          ...
          , iv = [tk, tD, tR]
          , ix = t => iv.find(e => e.test(t));
        function iw(t) {
            let e = ix(t);
            if (J(!!e, `'${t}' is not an animatable color. Use the equivalent color code instead.`, "color-not-animatable"),
            !e)
                return !1;
            let i = e.parse(t);
        ...
        let iT = (t, e) => {
            ...
            return t => (s.red = iy(i.red, n.red, t),
        ...
        function iS(t) {
            return "number" == typeof t ? ib : "string" == typeof t ? P(t) ? ig : tL.test(t) ? iT : iE : Array.isArray(t) ? iA : "object" == typeof t ? tL.test(t) ? iT : iM : ig
        }
        function iA(t, e) {
            let i = [...t]
              , n = i.length
        ...
        let iE = (t, e) => {
            let i = tW.createTransformer(e)
              , n = tI(t)
              , s = tI(e);
            return n.indexes.var.length === s.indexes.var.length && n.indexes.color.length === s.indexes.color.length && n.indexes.number.length >= s.indexes.number.length ? iP.has(t) && !s.values.length || iP.has(e) && !n.values.length ? iP.has(t) ? i => i <= 0 ? t : e : i => i >= 1 ? e : t : iu(iA(function(t, e) {
                let i = []
                  , n = {
                    color: 0,
                    var: 0,
                ...
                return i
            }(n, s), s.values), i) : (J(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"),
            ig(t, e))
        }
        ;
        function iV(t, e, i) {
            return "number" == typeof t && "number" == typeof e && "number" == typeof i ? A(t, e, i) : iS(t)(t, e)
        }
        let iC = t => {
        ...
        function iI(t=iL.visualDuration, e=iL.bounce) {
            let i;
            let n = "object" != typeof t ? {
              ...
              , {stiffness: h, damping: u, mass: d, duration: c, velocity: p, isResolvedFromDuration: m} = function(t) {
                ...
                if (!iO(t, iB) && iO(t, iF)) {
                    if (t.visualDuration) {
                        ...
                        let i = function({duration: t=iL.duration, bounce: e=iL.bounce, velocity: i=iL.velocity, mass: n=iL.mass}) {
                            let s, r;
                            J(t <= id(iL.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
                            let a = 1 - e;
                            a = I(iL.minDamping, iL.maxDamping, a),
                            t = I(iL.minDuration, iL.maxDuration, ic(t)),
                            a < 1 ? (s = e => {
                                let n = e * a
                                  , s = n * t;
              ...
              , v = ic(Math.sqrt(h / d))
              , x = 5 > Math.abs(y);
            if (s || (s = x ? iL.restSpeed.granular : iL.restSpeed.default),
            ...
            let w = {
                ...
                ,
                toString: () => {
                    let t = Math.min(ik(w), 2e4)
                      , e = iD(e => w.next(t * e).value, t, 30);
                    return t + "ms " + e
                }
                ,
                toTransition: () => {}
        ...
        function iU({keyframes: t, velocity: e=0, power: i=.8, timeConstant: n=325, bounceDamping: s=10, bounceStiffness: r=500, modifyTarget: a, min: o, max: l, restDelta: h=.5, restSpeed: u}) {
            let d, c;
            let p = t[0]
              , m = {
                done: !1,
              ...
              , g = t => void 0 === o ? l : void 0 === l ? o : Math.abs(o - t) < Math.abs(l - t) ? o : l
              , y = i * e
              , v = p + y
              , x = void 0 === a ? v : a(v);
            x !== v && (y = x - p);
        ...
        ;
        let iN = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
        function i$(t, e, i, n) {
            if (t === e && i === n)
                return ta;
            let s = e => (function(t, e, i, n, s) {
                ...
                let o = 0;
                do
                    (r = iN(a = e + (i - e) / 2, n, s) - t) > 0 ? i = a : e = a;
                while (Math.abs(r) > 1e-7 && ++o < 12);
                return a
            }
            )(e, 0, 1, t, i);
            return t => 0 === t || 1 === t ? t : iN(s(t), e, n)
        }
        let iW = i$(.42, 0, 1, 1)
          , iz = i$(0, 0, .58, 1)
          , iY = i$(.42, 0, .58, 1)
          ...
          , iq = iK(iZ)
          , i_ = iX(iq)
          , iG = t => (t *= 2) < 1 ? .5 * iq(t) : .5 * (2 - Math.pow(2, -10 * (t - 1)))
          ...
          , i3 = t => {
            ...
            return i5(t) ? (Q(void 0 !== i2[t], `Invalid easing type '${t}'`, "invalid-easing-type"),
            i2[t]) : t
        }
          , i9 = (t, e, i) => {
            let n = e - t;
        ...
        ;
        function i4({duration: t=300, keyframes: e, times: i, ease: n="easeInOut"}) {
            let s = iH(n) ? n.map(i3) : i3(n)
              , r = {
                done: !1,
                value: e[0]
            }
              , a = function(t, e, {clamp: i=!0, ease: n, mixer: s}={}) {
                let r = t.length;
                if (Q(r === e.length, "Both input and output ranges must be the same length", "range-length"),
                1 === r)
                    return () => e[0];
                if (2 === r && e[0] === e[1])
                    return () => e[1];
                ...
                let o = function(t, e, i) {
                    ...
                    for (let i = 0; i < r; i++) {
                        let r = s(t[i], t[i + 1]);
                        e && (r = iu(Array.isArray(e) ? e[i] || ta : e, r)),
                        n.push(r)
                    }
                    return n
                }(e, n, s)
                ...
                ease: Array.isArray(s) ? s : e.map( () => s || iY).splice(0, e.length - 1)
            });
            return {
        ...
        class nn extends ne {
            ...
            initAnimation() {
                let {options: t} = this;
                nt(t);
                let {type: e=i4, repeat: i=0, repeatDelay: n=0, repeatType: s, velocity: r=0} = t
                  , {keyframes: a} = t
                  , o = e || i4;
                o !== i4 && "number" != typeof a[0] && (this.mixKeyframes = iu(ni, iV(a[0], a[1])),
                a = [0, 100]);
                let l = o({
                    ...t,
                    keyframes: a
            ...
            tick(t, e=!1) {
                let {generator: i, totalDuration: n, mixKeyframes: s, mirroredGenerator: r, resolvedDuration: a, calculatedDuration: o} = this;
                ...
                s && (w.value = s(w.value));
                let {done: T} = w;
                y || null === o || (T = this.playbackSpeed >= 0 ? this.currentTime >= n : this.currentTime <= 0);
                let P = null === this.holdTime && ("finished" === this.state || "running" === this.state && T);
                return P && p !== iU && (w.value = i7(h, this.options, f, this.speed)),
                m && m(w.value),
                P && this.finish(),
                w
            }
            ...
            get duration() {
                return ic(this.calculatedDuration)
            }
            get iterationDuration() {
                let {delay: t=0} = this.options || {};
                return this.duration + ic(t)
            }
            get time() {
                return ic(this.currentTime)
            }
            set time(t) {
                t = id(t),
                this.currentTime = t,
            ...
            set speed(t) {
                ...
                e && (this.time = ic(this.currentTime))
            }
            play() {
                if (this.isStopped)
                    return;
        ...
        let na = nr( () => void 0 !== window.ScrollTimeline)
          , no = {}
          , nl = function(t, e) {
            let i = nr(t);
            return () => no[e] ?? i()
        ...
        class nc extends ne {
            constructor(t) {
                ...
                !t)
                    return;
                let {element: e, name: i, keyframes: n, pseudoElement: s, allowFlatten: r=!1, finalKeyframe: a, onComplete: o} = t;
                this.isPseudoElement = !!s,
                this.allowFlatten = r,
                this.options = t,
                Q("string" != typeof t.type, 'Mini animate() doesn\'t support "type" as a string.', "mini-spring");
                let l = function({type: t, ...e}) {
                    return nd(t) && nl() ? t.applyToOptions(e) : (e.duration ?? (e.duration = 300),
                ...
                this.animation = function(t, e, i, {delay: n=0, duration: s=300, repeat: r=0, repeatType: a="loop", ease: o="easeOut", times: l}={}, h) {
                    ...
                    let d = function t(e, i) {
                        if (e)
                            return "function" == typeof e ? nl() ? iD(e, i) : "ease-out" : i1(e) ? nh(e) : Array.isArray(e) ? e.map(e => t(e, i) || nu.easeOut) : nu[e]
                    }(o, s);
                    ...
                    h && (c.pseudoElement = h);
                    let p = t.animate(u, c);
                    return th.value && p.finished.finally( () => {
                        ip.waapi--
                    }
                    ),
                    p
                ...
                this.animation.onfinish = () => {
                    ...
                    !s) {
                        let t = i7(n, this.options, a, this.speed);
                        this.updateMotionValue ? this.updateMotionValue(t) : ns(i) ? e.style.setProperty(i, t) : e.style[i] = t,
            ...
            get duration() {
                return ic(Number(this.animation.effect?.getComputedTiming?.().duration || 0))
            }
            get iterationDuration() {
                let {delay: t=0} = this.options || {};
                return this.duration + ic(t)
            ...
            get time() {
                return ic(Number(this.animation.currentTime) || 0)
            }
            set time(t) {
                this.finishedTime = null,
        ...
        class nm extends nc {
            ...
            updateMotionValue(t) {
                ...
                let a = new nn({
                  ...
                  , o = id(this.finishedTime ?? this.time);
                e.setWithVelocity(a.sample(o - 10).value, a.sample(o).value, 10),
                a.stop()
            }
        }
        let nf = (t, e) => "zIndex" !== e && !!("number" == typeof t || Array.isArray(t) || "string" == typeof t && (tW.test(t) || "0" === t) && !t.startsWith("url("))
          , ng = new Set(["opacity", "clipPath", "filter", "transform"])
          , ny = nr( () => Object.hasOwnProperty.call(Element.prototype, "animate"));
        class nv extends ne {
            ...
            onKeyframesResolved(t, e, i, n) {
                ...
                !function(t, e, i, n) {
                    ...
                    let r = t[t.length - 1]
                      , a = nf(s, e)
                      , o = nf(r, e);
                    return J(a === o, `You are trying to animate ${e} from "${s}" to "${r}". "${a ? r : s}" is not an animatable value.`, "value-not-animatable"),
                    !!a && !!o && (function(t) {
                        let e = t[0];
                        if (1 === t.length)
                            return !0;
                ...
                }(t, s, r, a) && ((to.instantAnimations || !o) && h?.(i7(t, i, e)),
                t[0] = t[t.length - 1],
                il(i),
                i.repeat = 0);
                let u = {
                  ...
                  , d = !l && function(t) {
                    let {motionValue: e, name: i, repeatDelay: n, repeatType: s, damping: r, type: a} = t;
                    if (!(e?.owner?.current instanceof HTMLElement))
                        return !1;
                    let {onUpdate: o, transformTemplate: l} = e.owner.getProps();
                    return ny() && i && ng.has(i) && ("transform" !== i || !l) && !o && !n && "mirror" !== s && 0 !== r && "inertia" !== a
                }(u) ? new nm({
                    ...u,
                    element: u.motionValue.owner.current
                }) : new nn(u);
                d.finished.then( () => this.notifyFinished()).catch(ta),
        ...
        let nx = t => null !== t
          ...
          , nS = (t, {keyframes: e}) => e.length > 2 ? nP : o.has(t) ? t.startsWith("scale") ? nT(e[1]) : nw : nb
          , nA = (t, e, i, n={}, s, r) => a => {
            let o = ir(n, t) || {}
              , l = o.delay || n.delay || 0
              , {elapsed: h=0} = n;
            ...
            !function({when: t, delay: e, delayChildren: i, staggerChildren: n, staggerDirection: s, repeat: r, repeatType: a, repeatDelay: o, from: l, elapsed: h, ...u}) {
                return !!Object.keys(u).length
            }(o) && Object.assign(u, nS(t, u)),
            u.duration && (u.duration = id(u.duration)),
            u.repeatDelay && (u.repeatDelay = id(u.repeatDelay)),
            void 0 !== u.from && (u.keyframes[0] = u.from);
            let d = !1;
            if (!1 !== u.type && (0 !== u.duration || u.repeatDelay) || (il(u),
            0 !== u.delay || (d = !0)),
            (to.instantAnimations || to.skipAnimations) && (d = !0,
            il(u),
            u.delay = 0),
            ...
            return o.isSync ? new nn(u) : new nv(u)
        }
        ;
        function nM(t, e, {delay: i=0, transitionOverride: n, type: s}={}) {
            ...
            for (let e in o) {
                ...
                let a = {
                  ...
                  , u = n.get();
                if (void 0 !== u && !n.isAnimating && !Array.isArray(s) && s === u && !a.velocity)
                    continue;
                let d = !1;
                ...
                io(t, e),
                n.start(nA(e, n, s, t.shouldReduceMotion && O.has(e) ? {
                    type: !1
                } : a, t, d));
                let c = n.animation;
                c && l.push(c)
            ...
            return a && Promise.all(l).then( () => {
                td.update( () => {
                    a && function(t, e) {
                        let {transitionEnd: i={}, transition: n={}, ...s} = is(t, e) || {};
                        for (let e in s = {
                            ...s,
                            ...i
                        }) {
              ...
              , a = t.variantChildren && t.variantChildren.size ? (n=0) => {
                ...
                return function(t, e, i=0, n=0, s=0, r=1, a) {
                    ...
                    for (let l of t.variantChildren)
                        ...
                        o.push(nV(l, e, {
                            ...a,
                            delay: i + ("function" == typeof n ? 0 : n) + nE(t.variantChildren, l, n, s, r)
                ...
                t.animationState || (t.animationState = function(t) {
                    let e = e => Promise.all(e.map( ({animation: e, options: i}) => (function(t, e, i={}) {
                        ...
                        Array.isArray(e))
                            ...
                            let s = "function" == typeof e ? is(t, e, i.custom) : e;
                      ...
                      , n = !0
                      , s = e => (i, n) => {
                        let s = is(t, n, "exit" === e ? t.presenceContext?.custom : void 0);
                        if (s) {
                    ...
                    function r(r) {
                        ...
                        for (let e = 0; e < nR; e++) {
                            ...
                            !1 === y && (d = e);
                            let v = f === o[p] && f !== a[p] && g;
                            if (v && n && t.manuallyAnimateOnMount && (v = !1),
                            m.protectedKeys = {
                                ...u
                            },
                            !m.isActive && null === y || !f && !m.prevProp || em(f) || "boolean" == typeof f)
                                continue;
                            let x = (c = m.prevProp,
                            "string" == typeof f ? f !== c : !!Array.isArray(f) && !nC(f, c))
                              , w = x || p === r && m.isActive && !v && g || e > d && g
                              , T = !1
                            ...
                            for (let t in A) {
                                ...
                                if (!u.hasOwnProperty(t))
                                    (ia(e) && ia(i) ? nC(e, i) : e === i) ? void 0 !== e && h.has(t) ? M(t) : m.protectedKeys[t] = !0 : null != e ? M(t) : h.add(t)
                            }
                            m.prevProp = f,
                            ...
                            w && V && l.push(...P.map(e => {
                                ...
                                if ("string" == typeof e && n && !E && t.manuallyAnimateOnMount && t.parent) {
                                    let {parent: n} = t
                                      , s = is(n, e);
                        ...
                        if (h.size) {
                            ...
                            if ("boolean" != typeof a.initial) {
                                let i = is(t, Array.isArray(a.initial) ? a.initial[0] : a.initial);
        ...
        let nz = t => e => n$(e) && t(e, nW(e));
        function nY(t, e, i, n) {
            return nN(t, e, nz(i), n)
        }
        function nH(t) {
            return t.max - t.min
        }
        ...
        function nK(t, e, i, n) {
            nX(t.x, e.x, i.x, n ? n.originX : void 0),
            nX(t.y, e.y, i.y, n ? n.originY : void 0)
        }
        function nZ(t, e, i) {
            t.min = i.min + e.min,
            t.max = t.min + nH(e)
            ...
            constructor(t, e, {transformPagePoint: i, contextWindow: n=window, dragSnapToOrigin: s=!1, distanceThreshold: r=3}={}) {
                ...
                this.updatePoint = () => {
                    ...
                    if (!(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    let i = n5(this.lastMoveEventInfo, this.history)
                    ...
                    Math.sqrt(nQ(t.x, e.x) ** 2 + nQ(t.y, e.y) ** 2) >= this.distanceThreshold);
                    if (!n && !s)
                        return;
                    let {point: r} = i
                      , {timestamp: a} = tp;
                ...
                this.handlePointerUp = (t, e) => {
                    ...
                    !(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    let r = n5("pointercancel" === t.type ? this.lastMoveEventInfo : n1(e, this.transformPagePoint), this.history);
                ...
                let a = n1(nW(t), this.transformPagePoint)
                  , {point: o} = a
                  , {timestamp: l} = tp;
                this.history = [{
                    ...o,
                ...
                h && h(t, n5(a, this.history)),
                this.removeListeners = iu(nY(this.contextWindow, "pointermove", this.handlePointerMove), nY(this.contextWindow, "pointerup", this.handlePointerUp), nY(this.contextWindow, "pointercancel", this.handlePointerUp))
            }
            updateHandlers(t) {
                this.handlers = t
            }
        ...
        function n5({point: t}, e) {
            return {
                ...
                velocity: function(t, e) {
                    ...
                    let r = ic(s.timestamp - n.timestamp);
                    if (0 === r)
                        return {
                            x: 0,
                            y: 0
        ...
        class st {
            ...
            start(t, {snapToCursor: e=!1, distanceThreshold: i}={}) {
                ...
                this.panSession = new n0(t,{
                    onSessionStart: t => {
                        ...
                        e && this.snapToCursor(nW(t).point)
                    }
                    ,
                    onStart: (t, e) => {
                        let {drag: i, dragPropagation: n, onDragStart: s} = this.getProps();
                        if (i && !n && (this.openDragLock && this.openDragLock(),
                        this.openDragLock = "x" === i || "y" === i ? nU[i] ? null : (nU[i] = !0,
                        () => {
                            nU[i] = !1
                        }
                        ) : nU.x || nU.y ? null : (nU.x = nU.y = !0,
                        () => {
                            nU.x = nU.y = !1
                        }
                        ),
                    ...
                    ,
                    resumeAnimation: () => nG(t => "paused" === this.getAnimationState(t) && this.getAxisMotionValue(t).animation?.play())
                },{
            ...
            updateAxis(t, e, i) {
                ...
                this.constraints && this.constraints[t] && (r = function(t, {min: e, max: i}, n) {
                    return void 0 !== e && t < e ? t = n ? A(e, t, n.min) : Math.max(t, e) : void 0 !== i && t > i && (t = n ? A(i, t, n.max) : Math.min(t, i)),
                    t
            ...
            resolveConstraints() {
                let {dragConstraints: t, dragElastic: e} = this.getProps()
                  ...
                  , n = this.constraints;
                t && e7(t) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : t && i ? this.constraints = function(t, {top: e, left: i, bottom: n, right: s}) {
                    return {
                        x: n9(t.x, i, s),
                        y: n9(t.y, e, n)
                    }
                ...
                n !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && nG(t => {
            ...
            resolveRefConstraints() {
                ...
                let r = function(t, e, i) {
                    let n = B(t, i)
                      , {scroll: s} = e;
                    return s && (L(n.x, s.offset.x),
                    L(n.y, s.offset.y)),
                    n
                }(n, s.root, this.visualElement.getTransformPagePoint())
                  , a = {
                    x: n4((t = s.layout.layoutBox).x, r.x),
                    y: n4(t.y, r.y)
                };
                if (i) {
            ...
            startAnimation(t) {
                let {drag: e, dragMomentum: i, dragElastic: n, dragTransition: s, dragSnapToOrigin: r, onDragTransitionEnd: a} = this.getProps()
                  , o = this.constraints || {};
                return Promise.all(nG(a => {
                    if (!se(a, e, this.currentDirection))
                        return;
                    let l = o && o[a] || {};
                    r && (l = {
                        min: 0,
            ...
            startAxisValueAnimation(t, e) {
                ...
                return io(this.visualElement, t),
                    ...
                    if (e && !1 !== this.constraints) {
                        ...
                        n[t] = function(t, e) {
                            let i = .5
                              , n = nH(t)
                              , s = nH(e);
                            return s > n ? i = i9(e.min, e.max - n, t.min) : n > s && (i = i9(t.min, t.max - s, e.min)),
                            I(0, 1, i)
                        }({
                            min: i,
                            max: i
            ...
            addListeners() {
                ...
                let t = nY(this.visualElement.current, "pointerdown", t => {
                  ...
                  , e = () => {
                    ...
                    e7(t) && t.current && (this.constraints = this.resolveRefConstraints())
                }
                  , {projection: i} = this.visualElement
                ...
                i.updateLayout()),
                td.read(e);
                let s = nN(window, "resize", () => this.scalePositionWithinConstraints())
                  , r = i.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e}) => {
                    this.isDragging && e && (nG(e => {
                        let i = this.getAxisMotionValue(e);
        ...
        class ss extends nF {
            constructor() {
                super(...arguments),
                this.removePointerDownListener = ta
            }
            onPointerDown(t) {
            ...
            createPanHandlers() {
                ...
                return {
                    ...
                    onEnd: (t, e) => {
                        delete this.session,
                        n && td.postRender( () => n(t, e))
                    }
                }
            }
            mount() {
                this.removePointerDownListener = nY(this.node.current, "pointerdown", t => this.onPointerDown(t))
            }
            update() {
        ...
        let so = {
            correct: (t, e) => {
                ...
                let i = sa(t, e.target.x)
                  , n = sa(t, e.target.y);
                return `${i}% ${n}%`
            }
        }
          , sl = !1;
        class sh extends r.Component {
            componentDidMount() {
            ...
            getSnapshotBeforeUpdate(t) {
                ...
                t.isPresent === s || (s ? r.promote() : r.relegate() || td.postRender( () => {
                    let t = r.getStack();
        ...
        function sp(t) {
            return sc(t) && "ownerSVGElement"in t
        }
        let sm = (t, e) => t.depth - e.depth;
        class sf {
            constructor() {
                this.children = [],
                this.isDirty = !1
        ...
        function sV(t, e, [i,n,s], r, a) {
            !function(t, e=0, i=1, n=.5, s, r=t, a=t) {
                if (Y.test(e) && (e = parseFloat(e),
                e = A(a.min, a.max, e / 100) - a.min),
                "number" != typeof e)
                    return;
                let o = A(r.min, r.max, n);
                t === r && (o -= e),
                t.min = sE(t.min, e, i, o, s),
                t.max = sE(t.max, e, i, o, s)
            }(t, e[i], e[n], e[s], e.scale, r, a)
        }
        let sC = ["x", "scaleX", "originX"]
          , sD = ["y", "scaleY", "originY"];
        function sk(t, e, i, n) {
            sV(t.x, e, sC, i ? i.x : void 0, n ? n.x : void 0),
            sV(t.y, e, sD, i ? i.y : void 0, n ? n.y : void 0)
        }
        function sR(t) {
        ...
        function sY({attachResizeListener: t, defaultParent: e, measureScroll: i, checkIsScrollRoot: n, resetTransform: s}) {
            return class {
                constructor(t={}, i=e?.()) {
                    this.id = sW++,
                    this.animationId = 0,
                    ...
                    this.updateProjection = () => {
                        this.projectionUpdateScheduled = !1,
                        th.value && (sN.nodes = sN.calculatedTargetDeltas = sN.calculatedProjections = 0),
                        this.nodes.forEach(sK),
                        this.nodes.forEach(s0),
                        this.nodes.forEach(s1),
                        this.nodes.forEach(sZ),
                        th.addProjectionMetrics && th.addProjectionMetrics(sN)
                    }
                    ,
                ...
                addEventListener(t, e) {
                    return this.eventHandlers.has(t) || this.eventHandlers.set(t, new t9),
                ...
                mount(e) {
                    if (this.instance)
                        return;
                    this.isSVG = sp(e) && !(sp(e) && "svg" === e.tagName),
                    this.instance = e;
                    ...
                    t) {
                        ...
                        t(e, () => {
                            ...
                            sr.hasAnimatedSinceResize && (sr.hasAnimatedSinceResize = !1,
                    ...
                    !1 !== this.options.animate && s && (i || n) && this.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e, hasRelativeLayoutChanged: i, layout: n}) => {
                        ...
                        let r = this.options.transition || s.getDefaultTransition() || s6
                          , {onLayoutAnimationStart: a, onLayoutAnimationComplete: o} = s.getProps()
                          , l = !this.targetLayout || !sB(this.targetLayout, n)
                          , h = !e && i;
                ...
                update() {
                    ...
                    this.nodes.forEach(sX)) : this.nodes.forEach(sG),
                    this.clearAllSnapshots();
                    let t = t2.now();
                ...
                didUpdate() {
                    ...
                    ei.read(this.scheduleUpdate))
                }
                clearAllSnapshots() {
                    this.nodes.forEach(sq),
                    this.sharedNodes.forEach(s5)
                }
                ...
                updateSnapshot() {
                    ...
                    !this.snapshot || nH(this.snapshot.measuredBox.x) || nH(this.snapshot.measuredBox.y) || (this.snapshot = void 0))
                }
                updateLayout() {
                ...
                resetTransform() {
                    ...
                    let t = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout
                      , e = this.projectionDelta && !sL(this.projectionDelta)
                      , i = this.getTransformTemplate()
                      , n = i ? i(this.latestValues, "") : void 0
                      , r = n !== this.prevTransformTemplateValue;
                    t && this.instance && (e || V(this.latestValues) || r) && (s(this.instance, n),
                    this.shouldResetTransform = !1,
                    this.scheduleRender())
                }
                measure(t=!0) {
                ...
                removeElementScroll(t) {
                    ...
                    for (let i = 0; i < this.path.length; i++) {
                        ...
                        n !== this.root && s && r.layoutScroll && (s.wasRoot && sA(e, t),
                        L(e.x, s.offset.x),
                        L(e.y, s.offset.y))
                    }
                    return e
                ...
                applyTransform(t, e=!1) {
                    ...
                    for (let t = 0; t < this.path.length; t++) {
                        ...
                        V(n.latestValues) && F(i, n.latestValues)
                    }
                    return V(this.latestValues) && F(i, this.latestValues),
                    i
                }
                removeTransform(t) {
                    let e = eh();
                    ...
                    for (let t = 0; t < this.path.length; t++) {
                        let i = this.path[t];
                        if (!i.instance || !V(i.latestValues))
                            continue;
                        E(i.latestValues) && i.updateSnapshot();
                        let n = eh();
                        sA(n, i.measurePageBox()),
                        sk(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, n)
                    }
                    return V(this.latestValues) && sk(e, this.latestValues),
                    e
                }
                setTargetDelta(t) {
                    this.targetDelta = t,
                ...
                resolveTargetDelta(t=!1) {
                    ...
                    if (this.layout && (n || s)) {
                        if (this.resolvedRelativeTargetAt = tp.timestamp,
                        !this.targetDelta && !this.relativeTarget) {
                            ...
                            n_(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox),
                            sA(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                        }
                        if (this.relativeTarget || this.targetDelta) {
                            if (this.target || (this.target = eh(),
                            this.targetWithTransforms = eh()),
                            this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) {
                                ...
                                this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : sA(this.target, this.layout.layoutBox),
                                R(this.target, this.targetDelta)) : sA(this.target, this.layout.layoutBox);
                            if (this.attemptToResolveRelativeTarget) {
                                ...
                                this.relativeTarget = eh(),
                                this.relativeTargetOrigin = eh(),
                                n_(this.relativeTargetOrigin, this.target, t.target),
                                sA(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                            }
                            th.value && sN.calculatedTargetDeltas++
                        }
                    }
                }
                getClosestProjectingParent() {
                    return !this.parent || E(this.parent.latestValues) || C(this.parent.latestValues) ? void 0 : this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
                }
                isProjecting() {
                ...
                calcProjection() {
                    ...
                    !function(t, e, i, n=!1) {
                        ...
                        if (a) {
                            ...
                            for (let o = 0; o < a; o++) {
                                ...
                                (!a || !a.props.style || "contents" !== a.props.style.display) && (n && s.options.layoutScroll && s.scroll && s !== s.root && F(t, {
                                    x: -s.scroll.offset.x,
                                    y: -s.scroll.offset.y
                                }),
                                r && (e.x *= r.x.scale,
                                e.y *= r.y.scale,
                                R(t, r)),
                                n && V(s.latestValues) && F(t, s.latestValues))
                            }
                    ...
                    this.projectionDelta && this.prevProjectionDelta ? (sM(this.prevProjectionDelta.x, this.projectionDelta.x),
                    sM(this.prevProjectionDelta.y, this.projectionDelta.y)) : this.createProjectionDeltas(),
                    nK(this.projectionDelta, this.layoutCorrected, o, this.latestValues),
                    this.treeScale.x === r && this.treeScale.y === a && sI(this.projectionDelta.x, this.prevProjectionDelta.x) && sI(this.projectionDelta.y, this.prevProjectionDelta.y) || (this.hasProjected = !0,
                    this.scheduleRender(),
                    this.notifyListeners("projectionUpdate", o)),
                    th.value && sN.calculatedProjections++
                }
                hide() {
                    this.isVisible = !1
                }
                ...
                setAnimationOrigin(t, e=!1) {
                    ...
                    let o = eh()
                      ...
                      , d = !!(l && !u && !0 === this.options.crossfade && !this.path.some(s4));
                    this.animationProgress = 0,
                    this.mixTargetDelta = e => {
                        ...
                        this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                            var h, c, p, m;
                            n_(o, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                        ...
                        function(t, e, i, n, s, r) {
                            s ? (t.opacity = A(0, i.opacity ?? 1, sT(n)),
                            t.opacityExit = A(e.opacity ?? 1, 0, sP(n))) : r && (t.opacity = A(e.opacity ?? 1, i.opacity ?? 1, n));
                            for (let s = 0; s < sy; s++) {
                                let r = `border${sg[s]}Radius`
                                  , a = sw(e, r)
                                  , o = sw(i, r);
                                (void 0 !== a || void 0 !== o) && (a || (a = 0),
                                o || (o = 0),
                                0 === a || 0 === o || sx(a) === sx(o) ? (t[r] = Math.max(A(sv(a), sv(o), n), 0),
                                (Y.test(o) || Y.test(a)) && (t[r] += "%")) : t[r] = o)
                            }
                ...
                startAnimation(t) {
                    ...
                    this.pendingAnimation && (tc(this.pendingAnimation),
                ...
                applyTransformsToTarget() {
                    ...
                    if (e && i && n) {
                        if (this !== t && this.layout && n && re(this.options.animationType, this.layout.layoutBox, n.layoutBox)) {
                            i = this.target || eh();
                            let e = nH(this.layout.layoutBox.x);
                            i.x.min = t.target.x.min,
                            i.x.max = i.x.min + e;
                            let n = nH(this.layout.layoutBox.y);
                            i.y.min = t.target.y.min,
                            i.y.max = i.y.min + n
                        }
                        sA(e, i),
                        F(e, s),
                        nK(this.projectionDeltaWithTransform, this.layoutCorrected, e, s)
                    }
                }
                ...
                resetSkewAndRotation() {
                    ...
                    for (let e = 0; e < s$.length; e++)
                        sz(`rotate${s$[e]}`, t, n, this.animationValues),
                        sz(`skew${s$[e]}`, t, n, this.animationValues);
                ...
                applyProjectionStyles(t, e) {
                    ...
                    if (this.needsReset) {
                        ...
                        t.visibility = "",
                        t.opacity = "",
                        t.pointerEvents = e5(e?.pointerEvents) || "",
                    ...
                    if (!this.projectionDelta || !this.layout || !n.target) {
                        ...
                        t.pointerEvents = e5(e?.pointerEvents) || ""),
                        this.hasProjected && !V(this.latestValues) && (t.transform = i ? i({}, "") : "none",
                        this.hasProjected = !1);
                        return
                    }
                    t.visibility = "";
                    ...
                    let r = function(t, e, i) {
                        ...
                        i) {
                            let {transformPerspective: t, rotate: e, rotateX: s, rotateY: r, skewX: a, skewY: o} = i;
                    ...
                    eD) {
                        if (void 0 === s[e])
                            continue;
                        let {correct: i, applyTo: a, isCSSVariable: o} = eD[e]
                    ...
                    this.options.layoutId && (t.pointerEvents = n === this ? e5(e?.pointerEvents) || "" : "none")
                }
                clearSnapshot() {
        ...
        function sX(t) {
            ...
            if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
                ...
                nK(a, i, e.layoutBox);
                let o = eo();
                r ? nK(o, t.applyTransform(n, !0), e.measuredBox) : nK(o, i, e.layoutBox);
                let l = !sL(a)
                  , h = !1;
                if (!t.resumeFrom) {
        ...
        function s9(t, e, i, n) {
            t.min = A(e.min, i.min, n),
            t.max = A(e.max, i.max, n)
        }
        function s4(t) {
        ...
        let s6 = {
          ...
          , s7 = t => "undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t)
          , s8 = s7("applewebkit/") && !s7("chrome/") ? Math.round : ta;
        function rt(t) {
            t.min = s8(t.min),
            t.max = s8(t.max)
        }
        ...
        class rh extends nF {
            mount() {
                ...
                t && (this.unmount = function(t, e, i={}) {
                    ...
                    r
                }(t, (t, e) => (rl(this.node, e, "Start"),
                t => rl(this.node, t, "End"))))
            }
            unmount() {}
        }
        class ru extends nF {
            ...
            mount() {
                this.unmount = iu(nN(this.node.current, "focus", () => this.onFocus()), nN(this.node.current, "blur", () => this.onBlur()))
            }
            unmount() {}
        }
            ...
            mount() {
                ...
                t && (this.unmount = function(t, e, i={}) {
                      ...
                      , a = t => {
                        ...
                        let r = e(n, t)
                          , a = (t, e) => {
                            ...
                            ry(t) && "function" == typeof r && r(t, {
                                success: e
                            })
                        }
                          , o = t => {
                            a(t, n === window || n === document || i.useGlobalTarget || rd(n, t.target))
                        }
                          , l = t => {
                            a(t, !1)
                        }
                    ...
                    return n.forEach(t => {
                        ...
                        sc(t) && "offsetHeight"in t && (t.addEventListener("focus", t => rg(t, s)),
                        rc.has(t.tagName) || -1 !== t.tabIndex || t.hasAttribute("tabindex") || (t.tabIndex = 0))
                    }
                    ),
                    r
                }(t, (t, e) => (rv(this.node, e, "Start"),
            ...
            startObserver() {
                ...
                return function(t, e, i) {
                    let n = function({root: t, ...e}) {
                        ...
                        let n = rT.get(i)
                          , s = JSON.stringify(e);
                        return n[s] || (n[s] = new IntersectionObserver(rb,{
                            root: t,
                            ...e
                        })),
                        n[s]
        ...
        let rM = function(t, e) {
            ...
            return new Proxy( (t, e) => n(t, e),{
                get: (s, r) => "create" === r ? n : (i.has(r) || i.set(r, ii(r, void 0, t, e)),
                i.get(r))
            })
        }({
            animation: {
